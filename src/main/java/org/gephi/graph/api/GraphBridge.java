...
public interface GraphBridge {
     ...
     * <p>
     * The <code>nodes</code> typically belong to another graph store. If nodes already exists in the current graph they
     * will be ignored.
     * <p>
     * All edges attached to <code>nodes</code> will be copied as well if their source and target exists in this graph
     * store.
     * <p>
