...
public class IntervalSetTest {
    ...
    public void testToStringDate() {
        ...
        set1.add(new Interval(AttributeUtils.parseDateTime("2012-07-17T00:02:21"),
                AttributeUtils.parseDateTime("2012-07-17T00:03:00")));
        Assert.assertEquals(set1.toString(TimeFormat.DATE), "<[2012-02-29, 2012-03-01]; [2012-07-17, 2012-07-17]>");
        Assert.assertEquals(set1
                .toString(TimeFormat.DOUBLE), "<[1330473600000.0, 1330560000000.0]; [1342483341000.0, 1342483380000.0]>");

        // Test with time zone printing:
        Assert.assertEquals(set1.toString(TimeFormat.DATE, ZonedDateTime
                .now(ZoneId.of("UTC"))), "<[2012-02-29, 2012-03-01]; [2012-07-17, 2012-07-17]>");
        Assert.assertEquals(set1.toString(TimeFormat.DATE, ZonedDateTime
                .now(ZoneId.of("+12:00"))), "<[2012-02-29, 2012-03-01]; [2012-07-17, 2012-07-17]>");
        set1.add(new Interval(AttributeUtils.parseDateTime("2012-07-18T18:30:00"),
                AttributeUtils.parseDateTime("2012-07-18T18:30:01")));
        Assert.assertEquals(set1.toString(TimeFormat.DATE, ZonedDateTime.now(ZoneId
                .of("+08:00"))), "<[2012-02-29, 2012-03-01]; [2012-07-17, 2012-07-17]; [2012-07-19, 2012-07-19]>");
        Assert.assertEquals(set1.toString(TimeFormat.DATE, ZonedDateTime.now(ZoneId
                .of("-10:00"))), "<[2012-02-28, 2012-02-29]; [2012-07-16, 2012-07-16]; [2012-07-18, 2012-07-18]>");
    ...
    public void testToStringDatetime() {
        ...
        set1.add(new Interval(AttributeUtils.parseDateTime("2012-02-29"), AttributeUtils.parseDateTime("2012-03-01")));
        Assert.assertEquals(set1
                .toString(TimeFormat.DATETIME), "<[2012-02-29T00:00:00.000Z, 2012-03-01T00:00:00.000Z]>");

        set1.add(new Interval(AttributeUtils.parseDateTime("2012-07-17T01:10:44"),
                AttributeUtils.parseDateTime("2012-07-17T01:10:45")));
        Assert.assertEquals(set1
                .toString(TimeFormat.DATETIME), "<[2012-02-29T00:00:00.000Z, 2012-03-01T00:00:00.000Z]; [2012-07-17T01:10:44.000Z, 2012-07-17T01:10:45.000Z]>");
        Assert.assertEquals(set1
                .toString(TimeFormat.DOUBLE), "<[1330473600000.0, 1330560000000.0]; [1342487444000.0, 1342487445000.0]>");

        // Test with time zone printing:
        Assert.assertEquals(set1.toString(TimeFormat.DATETIME, ZonedDateTime.now(ZoneId
                .of("UTC"))), "<[2012-02-29T00:00:00.000Z, 2012-03-01T00:00:00.000Z]; [2012-07-17T01:10:44.000Z, 2012-07-17T01:10:45.000Z]>");
        Assert.assertEquals(set1.toString(TimeFormat.DATETIME, ZonedDateTime.now(ZoneId
                .of("+12:00"))), "<[2012-02-29T12:00:00.000+12:00, 2012-03-01T12:00:00.000+12:00]; [2012-07-17T13:10:44.000+12:00, 2012-07-17T13:10:45.000+12:00]>");

        // Test with timezone parsing and UTC printing:
        IntervalSet set2 = new IntervalSet();
        set2.add(new Interval(AttributeUtils.parseDateTime("2012-02-29T00:00:00+02:30"),
                AttributeUtils.parseDateTime("2012-02-29T02:30:00+02:30")));
        Assert.assertEquals(set2
                .toString(TimeFormat.DATETIME), "<[2012-02-28T21:30:00.000Z, 2012-02-29T00:00:00.000Z]>");

        set2.add(new Interval(AttributeUtils.parseDateTime("2012-02-29T01:10:44+00:00"),
                AttributeUtils.parseDateTime("2012-02-29T01:10:45+00:00")));
        Assert.assertEquals(set2
                .toString(TimeFormat.DATETIME), "<[2012-02-28T21:30:00.000Z, 2012-02-29T00:00:00.000Z]; [2012-02-29T01:10:44.000Z, 2012-02-29T01:10:45.000Z]>");
        Assert.assertEquals(set2
                .toString(TimeFormat.DOUBLE), "<[1330464600000.0, 1330473600000.0]; [1330477844000.0, 1330477845000.0]>");
